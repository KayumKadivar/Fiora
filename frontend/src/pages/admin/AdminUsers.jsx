      ...
      <div className="bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-[2rem] overflow-hidden shadow-xl backdrop-blur-sm">
        <div className="p-8 border-b border-zinc-100 dark:border-white/5 flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-3">
             <span className="text-sm font-bold text-zinc-500 bg-zinc-100 dark:bg-white/5 px-3 py-1 rounded-full">Total: {users.length}</span>
             <button 
                onClick={() => setIsModalOpen(true)}
                className="flex items-center space-x-2 px-5 py-2.5 bg-gradient-to-r from-rose-600 to-orange-600 hover:from-rose-500 hover:to-orange-500 text-white font-bold text-sm rounded-xl transition-all duration-300 shadow-lg shadow-rose-500/20 transform hover:scale-[1.02] active:scale-[0.98]"
             >
        ...
        <div className="overflow-x-auto min-h-[200px] relative">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-zinc-50/50 dark:bg-white/5 text-zinc-500 dark:text-zinc-400 text-[10px] font-black uppercase tracking-[0.2em]">
            ...
            <tbody className="divide-y divide-zinc-100 dark:divide-white/5 text-sm font-medium">
              ...
              {users.map((user) => (
                <tr key={user._id || user.id} className="hover:bg-zinc-50 dark:hover:bg-white/5 transition-colors group">
                  ...
                  <td className="px-8 py-5">
                    <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider ${user.role === 'Admin' ? 'bg-rose-100 dark:bg-rose-500/20 text-rose-600 dark:text-rose-400' : 'bg-blue-100 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400'}`}>
                      {user.role}
                    </span>
                  </td>
                  <td className="px-8 py-5">
              ...
              <form onSubmit={handleCreateUser} className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-2 border-b border-zinc-100 dark:border-white/5 pb-2">
                    ...
                    <h3 className="text-sm font-black uppercase tracking-widest text-zinc-400">User Information</h3>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-1.5">
                      <label className="block text-sm font-bold text-zinc-500 dark:text-zinc-400 px-0.5 uppercase tracking-wider flex items-center">
                      ...
                      <input
                        ...
                        className="w-full bg-zinc-50 dark:bg-black/40 border border-zinc-100 dark:border-white/5 rounded-xl px-4 py-2.5 focus:outline-none focus:border-rose-500 transition-colors dark:text-white text-sm font-bold"
                        required
                      />
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="flex space-x-2">
                        <select 
                          ...
                          className="w-20 bg-zinc-50 dark:bg-black/40 border border-zinc-100 dark:border-white/5 rounded-xl px-2 py-2.5 focus:outline-none focus:border-rose-500 transition-colors dark:text-white text-sm font-bold"
                        >
                          <option>+91</option>
                          <option>+1</option>
                          <option>+44</option>
                        ...
                        <input
                          ...
                          className="flex-1 bg-zinc-50 dark:bg-black/40 border border-zinc-100 dark:border-white/5 rounded-xl px-4 py-2.5 focus:outline-none focus:border-rose-500 transition-colors dark:text-white text-sm font-bold"
                          required
                        />
                      </div>
                    </div>
                ...
                <div className="flex items-center justify-between pt-6 border-t border-zinc-100 dark:border-white/5">
                  ...
                  <div className="flex items-center space-x-4">
                    <button 
                      type="button" 
                      onClick={() => setIsModalOpen(false)}
                      className="px-6 py-2.5 rounded-xl border border-zinc-200 dark:border-white/10 text-zinc-600 dark:text-zinc-400 font-bold text-sm hover:bg-zinc-50 dark:hover:bg-white/5 transition-colors"
                    ...
                    <button 
                      type="submit" 
                      disabled={isSubmitting}
                      className="px-8 py-2.5 bg-gradient-to-r from-rose-600 to-orange-600 hover:from-rose-500 hover:to-orange-500 text-white font-bold text-sm rounded-xl transition-all duration-300 shadow-lg shadow-rose-500/20 transform hover:scale-[1.02] active:scale-[0.98] flex items-center"
                    >
